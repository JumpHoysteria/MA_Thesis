...
\textbf{d)} Relative amount of cells that showed fluorescence level impulse response. (***p$<$0.0001, ANOVA with Dunnette's multiple comparison test, Data is mean $\pm$ SEM, n = \myworries{WHAT})}
